...
3. **确认分析：** 使用最直接、简单的方案满足客户需求。

## step 2 系统设计
请根据以下要求输出产品设计文档：

### 产品规划概述
- **业务流程说明：** 根据客户需求描述产品业务流程。
- **功能实现：** 针对业务流程详细说明对应功能的实现方式。基于功能和实现流程需求，规划页面。让相关联的功能在同一个页面。
- **流程图规划：** 使用 Mermaid 语法绘制产品流程图。
...
**输出要求：**
1. **页面清单：** 根据产品规划概述，输出所有页面的清单，需包含：页面名称、页面路径、页面描述、主要栏目、数据流向、其他页面的业务关系及页面间交互设计说明。
2. **页面及功能设计说明：** 针对每个页面，详细说明：
   - **页面名称：** （与页面清单保持一致）
   - **功能概要：** 说明主要功能和数据流向。
   - **页面入口：** 指定入口路径。
   - **页面布局：** 说明各功能区域及其包含的栏目和具体功能。
