...
###### **页面布局设计**
    ...
    **主体页面布局**
    - 使用ASCII字符绘制主体页面的示意图
    - 示意图中需要包含页面中的所有主要功能项，比如一个典型列表页面中的标题、搜索栏、列表、分页、操作按钮等
    - 主体页面应专注于核心数据展示和基本操作，复杂功能通过弹窗完成
    - 确保主体页面布局简洁明了，用户能够快速定位和理解主要功能
...
**主体页面功能区**
- 重点描述主体页面的核心功能，如列表展示、搜索筛选、页面级操作按钮等
- 确保主体页面功能简洁明了，复杂功能通过弹窗完成

**弹窗功能区**
- 每个弹窗都要单独作为一个功能区进行详细描述
- 弹窗设计要包含以下要素：
  - 弹窗标题：明确弹窗的功能
  - 触发机制：如何打开弹窗
  - 表单字段：详细的字段规范（参考表单规范）
...
**页面交互流程**
- 在各功能区详情之后，增加页面交互流程部分，说明：
  - 主体页面交互流程：用户在主页面的操作路径
  - 弹窗交互流程：各个弹窗的操作流程
  - 数据流转：操作完成后的数据更新和页面刷新机制
